...
public class ZhuanQuAdapter extends BaseAdapter<HomePagerBean.ResultBean.GkzqBean> {
    ...
    public ZhuanQuAdapter(List<HomePagerBean.ResultBean.GkzqBean> dataList, Context context) {
        super(dataList);
    ...
    @Override
    public void createHolder(ViewHolder holder, HomePagerBean.ResultBean.GkzqBean moduleBean, int position) {
