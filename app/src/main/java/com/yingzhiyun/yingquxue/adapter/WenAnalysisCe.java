...
public  class WenAnalysisCe extends RecyclerView.Adapter<WenAnalysisCe.MyViewHolder> {
    private Context context;
    private List<ExamineBean.ResultBean.DaTiBeanListBean.StemBeanListBean.StemListBean.OptionsListBean> list;

    private int defItem = -1;


    public WenAnalysisCe(Context context, List<ExamineBean.ResultBean.DaTiBeanListBean.StemBeanListBean.StemListBean.OptionsListBean> list) {
