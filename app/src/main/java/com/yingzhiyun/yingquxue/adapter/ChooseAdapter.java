 ...
 */
 public  class ChooseAdapter extends RecyclerView.Adapter<ChooseAdapter.MyViewHolder> {
    ...
    public ChooseAdapter(Context context, List<TestPagperInfo.ResultBean.DaTiBeanListBean.StemBeanListBean.OptionsListBean> list,String type) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        for (int i = 0; i <list.get(position).getText().size() ; i++) {
            if(list.get(position).getText().get(i).getContentType().equals("text")){
                ...
                Log.d("moxun", "onBindViewHolder: "+list.get(position).getText().get(i).getContent());
