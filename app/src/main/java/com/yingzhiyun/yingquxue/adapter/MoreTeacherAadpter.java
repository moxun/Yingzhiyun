...
public class MoreTeacherAadpter extends BaseAdapter<ZiyuanBean.ResultBean> {


    private final Context context;

    public MoreTeacherAadpter(List<ZiyuanBean.ResultBean> dataList, Context context) {
        super(dataList);
