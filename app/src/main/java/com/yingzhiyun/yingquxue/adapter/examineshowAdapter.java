...
public  class examineshowAdapter extends RecyclerView.Adapter<examineshowAdapter.MyViewHolder> {
    private Context context;
    private List<MyTiBean.ResultBean.OptionsListBean> list;

    private int defItem = -1;


    public examineshowAdapter(Context context, List<MyTiBean.ResultBean.OptionsListBean> list) {
