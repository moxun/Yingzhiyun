/** 
 * Project Name：starView 
 * File Name：StarView.java 
 * Package Name：com.hjp.starview 
 * Date：2016年3月4日 下午1:29:50 
...
public class StarView extends RelativeLayout {
	...
	/**
	 *DECIMAL ：返回百分比；HALF:返回的是星个数：WHOLE:返回的是星星个数
	 * @Title: getStar
	 * @Description:
	 * @return
	 */
