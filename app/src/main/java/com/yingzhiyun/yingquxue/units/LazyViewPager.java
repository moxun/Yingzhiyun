...
//import android.support.v4.view.KeyEventCompat;//API 26及其以下
...
//            mAdapter.registerDataSetObserver(mObserver);
    ...
    public void setOffscreenPageLimit(int limit) {
        if (limit < DEFAULT_OFFSCREEN_PAGES) {
            Log.i(TAG, "Requested offscreen page limit " + limit + " too small; defaulting to " +
    ...
    void populate() {
        ...
        if (DEBUG) Log.i(TAG, "populating: startPos=" + startPos + " endPos=" + endPos);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < size; ++i) {
            ...
            if (child.getVisibility() != GONE) {
                if (DEBUG) Log.i(TAG, "Measuring #" + i + " " + child
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE && (ii = infoForChild(child)) != null) {
                ...
                if (DEBUG) Log.i(TAG, "Positioning #" + i + " " + child + " f=" + ii.object
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_CANCEL || action == MotionEvent.ACTION_UP) {
            // Release the drag.
            if (DEBUG) Log.i(TAG, "Intercept done!");
        ...
        if (action != MotionEvent.ACTION_DOWN) {
            if (mIsBeingDragged) {
                if (DEBUG) Log.i(TAG, "Intercept returning true!");
                return true;
            }
            if (mIsUnableToDrag) {
                if (DEBUG) Log.i(TAG, "Intercept returning false!");
                return false;
            }
        }
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE: {
                ...
                */
                ...
                if (xDiff > mTouchSlop && xDiff > yDiff) {
                    if (DEBUG) Log.i(TAG, "Starting drag!");
                    ...
                    if (yDiff > mTouchSlop) {
                        ...
                        if (DEBUG) Log.i(TAG, "Starting unable to drag!");
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                if (DEBUG) Log.i(TAG, "Down at " + mLastMotionX + "," + mLastMotionY
...
//                    /**
//                     * API 26及其以下使用KeyEventCompat.hasNoModifiers(event)和KeyEventCompat.hasModifiers(event, KeyEvent.META_SHIFT_ON)
//                     */
...
//                    }
                    ...
                    /**
                     * API 27及其以上使用event.hasNoModifiers()和event.hasModifiers(KeyEvent.META_SHIFT_ON)
                     */
