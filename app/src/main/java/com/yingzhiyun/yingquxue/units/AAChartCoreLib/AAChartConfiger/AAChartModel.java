...
import com.yingzhiyun.yingquxue.units.AAChartCoreLib.AAChartEnum.AAChartStackingType;
...
public class AAChartModel {
    ...
    public AAChartModel() {
        ...
        colorsTheme           = new String[]{"#1091E9","#ffc069","#06caf4","#7dffc0"};//默认的颜色数组(必须要添加默认数组,否则就会出错)
