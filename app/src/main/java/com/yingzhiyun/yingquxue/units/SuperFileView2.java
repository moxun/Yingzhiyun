...
public class SuperFileView2 extends FrameLayout implements TbsReaderView.ReaderCallback {
    ...
    public void displayFile(File mFile) {
        ...
        if (mFile != null && !TextUtils.isEmpty(mFile.toString())) {
            ...
            param.putString("tempPath","/storage/emulated/0/Android/data/com.yingzhiyun.yingquxue/files/Documents");
            param.putString("filePath",mFile.toString());

            if (this.mTbsReaderView == null)
                this.mTbsReaderView = getTbsReaderView(context);
            boolean bool = this.mTbsReaderView.preOpen(getFileType(mFile.toString()), false);
            if (bool) {
                this.mTbsReaderView.openFile(param);
            }
        } else {
            TLog.e("文件路径无效！");
        }
