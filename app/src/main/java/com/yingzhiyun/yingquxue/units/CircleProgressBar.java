...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        outsideRadius = a.getDimension(R.styleable.CircleProgressBar_outside_radius, DeviceUtils.px2dp(getContext(), 60));
        insideColor = a.getColor(R.styleable.CircleProgressBar_inside_color, ContextCompat.getColor(getContext(), R.color.white));
        ...
        progressTextSize = a.getDimension(R.styleable.CircleProgressBar_progress_text_size, DeviceUtils.px2dp(getContext(), 14));
        progressWidth = a.getDimension(R.styleable.CircleProgressBar_progress_width, DeviceUtils.px2dp(getContext(), 10));
