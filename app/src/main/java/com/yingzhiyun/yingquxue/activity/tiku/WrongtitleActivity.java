...
public class WrongtitleActivity extends BaseActicity<WrongMvp.Wrong_View, WrongPresenter<WrongMvp.Wrong_View>> implements WrongMvp.Wrong_View {
    ...
    protected void initData() {
        ...
        toolTitle.setText("错题本");
        detailBeans = new ArrayList<>();
        highsubject = new ArrayList<>();
        middlesubject = new ArrayList<>();
        wrongListAdapter = new WrongListAdapter(detailBeans, this, "错题本");
    ...
    protected void onResume() {
        ...
        highsubject.clear();
        detailBeans.clear();
        mPresentser.getWronglist(new Gson().toJson(new WrongListJson(SharedPreferenceUtils.getUserid(), SharedPreferenceUtils.getToken(), id, MyApp.version, "Android")));
    }
}
